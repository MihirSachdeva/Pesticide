    ...
    <div>
      ...
      >
        <DialogTitle id="responsive-dialog-title" className="modal-title-issue">
          <div>
            <Button
              className="btn-filled-small btn-filled-bg-transparent"
              onClick={handleClose}
            >
              <CloseRoundedIcon />
            </Button>
            {props.projectname} • Issue{" "}
            {!props.showProjectNameOnCard && props.issueIndex}
          </div>
          {(props.reporterDetails.id == props.currentUser.id ||
            ...
            <div className="issue-section">
              <div className="issue-detail">
                ...
                <div className="issue-buttons">
                  ...
                  <Link
                    to={"/users/" + props.reporterDetails.enrollment_number}
                ...
                <div className="issue-buttons">
                  ...
                  <div className="project-issue-tags issue-tag-text">
                    {props.tags.map((tag) => (
                      ...
                      >
                        <div>#{props.tagNameColorList[tag].tagText}</div>
                      </Button>
                    ))}
                  </div>
                </div>

                <div className="issue-heading">{props.title}</div>
                ...
                <div className="issue-images-container">
                  <div className="issue-image">
                    {props.image && (
                      <ImageWithModal src={props.image.image} alt="Issue" />
                    )}
                  </div>
                </div>
                      ...
                      <div className={commentClass} id={comment.id}>
                        ...
                        <div className="comment-bottom">
                          ...
                          <div
                            ...
                            style={{ backgroundColor: commentAfterBgColor }}
                          />
                        </div>
                      </div>
                    );
