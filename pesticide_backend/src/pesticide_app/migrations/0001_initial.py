...
import pesticide_app.models.user
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_picture', models.ImageField(blank=True, null=True, upload_to=pesticide_app.models.user.upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Open', 'Open'), ('Fixed', 'Fixed'), ('Production', 'Production'), ('Not_a_bug', 'Not_a_bug'), ('Needs_more_information', 'Needs_more_information'), ('Unclear', 'Unclear')], default='Open', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Testing', 'Testing'), ('Deployed', 'Deployed'), ('Production', 'Production'), ('Development', 'Development'), ('Scrapped', 'Scrapped'), ('Finished', 'Finished')], default='Testing', max_length=20)),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='creator', to=settings.AUTH_USER_MODEL)),
                ('members', models.ManyToManyField(related_name='project_member_related', related_query_name='project_member', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-timestamp'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pesticide_app.Project')),
            ],
        ),
        migrations.CreateModel(
            name='IssueImage',
        ...
        migrations.AddField(
            model_name='issue',
            name='tags',
            field=models.ManyToManyField(default='Bug', to='pesticide_app.Tag'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
