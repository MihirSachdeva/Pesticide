...
class EmailSubscription(models.Model):
    ...
    on_new_issue = models.BooleanField(default=True, blank=True, null=True) # sent to project members
    on_issue_assign = models.BooleanField(default=True, blank=True, null=True) # sent to project members and issue assignee
    on_issue_status_change = models.BooleanField(default=True, blank=True, null=True) # sent to project members and issue reporter
    on_new_comment = models.BooleanField(default=True, blank=True, null=True) # sent to project members and issue reporter
